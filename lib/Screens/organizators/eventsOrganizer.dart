...
import 'package:eventflow/Screens/organizators/organizerEventdetail.dart';
        ...
        builder: (context, streamSnapshot) {
          if (streamSnapshot.hasData) {
            filteredEvents = streamSnapshot.data!.docs.where((event) {
              final organiser_user_userId = _authService.currentUser!.uid;
              ...
              return (organiser_user_userId == organizer_userId) && (selectedCategory == 'Toutes' || eventCategory == selectedCategory.toLowerCase()) &&
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) {
                                ...
                                return EventOrganizerDetailsPage(event: event);
                              },
                            ),
                          );
                        },
